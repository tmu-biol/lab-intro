...
var documents = [{
    ...
    "title": "細胞生化学研究室",
    "body": "2021/11/19 - 初めまして、細胞生化学研究室です！私たちは培養細胞を用いて、膜タンパク質や、RNA結合タンパク質等の機能解析を行なっています。コアタイムは厳密には決められていませんが、基本的に平日の10時から17時まで活動しています。ゼミは週に一回、水曜か金曜の13時から行われており、研究の進捗報告と論文の紹介を行なっています。現在のメンバーは教授、助教、特任助教、秘書さん、博士課程４人、修士課程９人、卒研生８人が在籍しています。配属されたばかりの時期は、卒研生にはそれぞれ先輩方がついて、非常に手厚い指導が受けれます。とてもアットホームで賑やかなラボです。気になった方は是非気軽に見学に来てください！ 卒研テーマ例:  XLMR原因遺伝子産物Rab39bの代謝におけるGDI1の役割 Hibit-tagを用いたBAG6複合体構成因子発現を定量する系の確立 TanGIBLEを用いたストレス応答標的タンパク質群の同定方開発ゼミ回数:  週１回"
    }, {
    "id": 13,
    "url": "/lab-intro/evogen/",
    "title": "進化遺伝学研究室",
    "body": "2021/11/18 - 学部3年生の皆さんこんにちは！進化遺伝学研究室です。我々の研究室では、生物進化のメカニズムを遺伝子やゲノムのレベルで解明することを目指しています。野外採集に始まり、分子生物学、生物情報学的手法を用いた幅広い研究がモットーです。担当教員は田村先生、高橋先生、野澤先生の3名で、その他に、客員研究員1名、系統維持担当職員1名、研究室秘書1名、技官3名、PD2名、RA1名、博士課程7名、修士課程10名、卒研生5名が所属しています。ゼミは毎週月曜日の午前中に行っており、基本的にコアタイムはありません。アットホームな研究室なので、ぜひ見学にいらして下さい！！ 卒研テーマ例:  アカショウジョウバエの低温耐性の遺伝機構と熱帯から温帯への適応進化のメカニズム ショウジョウバエにおけるアキアズミー（雄組換え抑制）の遺伝機構 分子系統解析に関する理論的研究とバイオインフォマティクス ショウジョウバエを用いた種分化の分子機構 ショウジョウバエにおける性染色体の進化メカニズム ショウジョウバエ抗菌ペプチドによる微生物環境適応のメカニズムゼミ回数:  週１回"
    }, {
    "id": 14,
    "url": "/lab-intro/neubio/",
    "title": "神経生物学研究室",
    "body": "2021/11/17 - 黒川先生とAdam先生のもと、D3:3人、B4：4人（黒川組:2人、Adam組:2人）、そのほか他大学の教授と連携して研究を行っております。研究内容:黒川組では、主に水生無脊椎動物を用いて、様々な生理現象を神経回路の側面から解明するための研究を行っております。ゼミは週に一回(本年は金曜午前8時〜10時)で、英語論文の紹介をローテーションで行っております。Adam組ではマウスを用いて海馬や記憶、神経新生などについての研究を行っております。ゼミは週に一回（本年は月曜午前、２時間程度） 、進捗発表や英語論文の紹介などを行っております。 今年の卒研生年間スケジュール:前期（４～８月）：機材の使い方や、テクニックを教わる。後期（9月～）:院の入試終了後、教授や先輩に相談に乗ってもらいながら、テーマの決定(テーマは基本自分で決める)。卒研にむけて研究中。 研究室の雰囲気:研究室でおしゃべりしたり、コロナがないときはBBQや研究室旅行もやってました。フィールドワークで実験動物を集める等、ややアクティブな研究室です。研究に打ち込むときはしっかりと研究をします。遊ぶときは遊ぶ、やるときはやる、メリハリのはっきりしている研究室だと思います。 PR：こんにちは、神経生物学研究室です。脳や神経、生理現象など興味のある方、一緒に研究できる日を待ち望んでいます。 卒研テーマ例:  光合成の神経生物学 ザリガニの尿コミュニケーション解析 変異体マウスを使った行動解析ゼミ回数:  週１回"
    }, {
    "id": 15,
    ...
    "title": "環境微生物学研究室",
    "body": "2021/11/15 - 研究の概要　微生物（細菌、アーキア）の生理・生態 ゼミ　Progress Report（1コマ/週）、Journal Club（1コマ/週） 卒研テーマ例:  新規微生物機能の探索 微生物の生残戦略機構の解明ゼミ回数:  週１回"
    }, {
    "id": 17,
    ...
    "title": "植物生態学研究室",
    "body": "2021/11/13 - ・学年ごとB4が5名M1が3名M2が3名D3が1名 ・ゼミの時間、内容基本は金曜の13:00から3時間程度。研究の進捗報告や論文紹介、自分の研究のバックグラウンドやデータ解析の発表などを行い、フィードバックを貰います！ ・研究室の雰囲気みんな優しい！ ・研究の概要主に栽培実験や野外調査、数理モデルを使ったシュミレーションなどを行なっています。興味のある事を自分で考えられると思います 卒研テーマ例:  スギナの根茎の生息環境による窒素への反応性について カキドオシのウイルス拡散と光同化物の動きの関係性についてゼミ回数:  週１回"
    }, {
    "id": 19,
    ...
    "title": "植物系統分類学研究室",
    "body": "2021/11/11 - こんにちは！植物系統分類学研究室です。 この研究室では、植物・菌類を対象に分類・進化・種分化・分布変遷などのテーマで研究をしています。 コアタイムはありません。ゼミは、毎週金曜日の13時～15時(16時スタートの日もあります)に動物系統分類学研究室と合同で行っています。 現在は、先生4名と学生(B4 1人、M1 3人、M2 3人、D1 3人)で構成されています。 研究室の雰囲気は、【家よりアットホーム(?)】です。 興味がある方は、ぜひ一度お話しにきてください！ ↓植物系統分類学研究室のページ↓ 植物系統分類学研究室 → "
    }, {
    "id": 22,
    ...
    "title": "行動生理学研究室【HPS】",
    "body": "2021/11/09 - こんにちは。行動生理学研究室です。私たちはラットを用いて生物の行動に関わる脳の仕組みについて研究しています。その内容はストレスと脳の関係、運動と脳の関係など様々です。大きな社会問題になっているうつ病に関連する研究を行っている人もいます。現在のメンバーは北先生の他、特任助教1名、修士課程の学生５名、卒研生１名です。今年度のゼミは金曜日の16時～18時で、毎週進捗報告を行い、残りの時間で論文紹介を行っています。コアタイムは設定されていないため活動時間の自由度が高く、自分のペースで実験を進めることが出来ます。また、アットホームな雰囲気でとても居心地がいいです！気軽に研究室見学に来てみてください。 卒研テーマ例:  自発運動による向社会的行動促進の神経機序 鉄欠乏とうつの関係について 自由な他個体の存在下における拘束ストレスが不安様行動に及ぼす影響ゼミ回数:  週１回"
    }, {
    "id": 24,
    "url": "/lab-intro/pladev/",
    "title": "植物環境応答研究室（鐘ヶ江グループ）",
    "body": "2021/11/07 - ※担当教員に直接アポをとってください。 "
    }];
